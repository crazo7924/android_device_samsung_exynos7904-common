...
include $(CLEAR_VARS)
LOCAL_MODULE := init.exynos7904
LOCAL_SRC_FILES := init.exynos7904.rc
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_STEM := init.exynos7904.rc
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := init.exynos7904.usb
LOCAL_SRC_FILES := init.exynos7904.usb.rc
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_STEM := init.exynos7904.usb.rc
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT_VENDOR_ETC)/init
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE := init.exynos7904.usb.configfs
LOCAL_SRC_FILES := init.exynos7904.usb.configfs.rc
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_STEM := init.exynos7904.usb.configfsrc
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT_VENDOR_ETC)/init
include $(BUILD_PREBUILT)
